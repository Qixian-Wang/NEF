...
class Model:
    def __init__(self, hebbian_lr, refractory, sigma_i=0.0,
                 connectivity=0,
                 transmitter_leakage=0,
                 transmitter_restoration=0,
                 stimulation_voltage=4,
                 stimulation_frequency=4,
                 groups_per_row=10,
                 n_per_group=10,
                 taupre=0,
                 taupost=0,
        ...
        self.app['excitatory_group'].theta = 0.01
        ...
        self.app['S2_monitor'] = StateMonitor(self.app['S2'], ['w', 'ge', 'Apre'], record=range(5), name='S2_monitor')
